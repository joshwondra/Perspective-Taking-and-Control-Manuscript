...
Another way to understand whether perspective taking makes people feel how the target of perspective taking feels is to see if the effects are emotion-specific. In other words, if there are differences in anger across conditions, do those differences only occur when the other person is angry? We examined differences in sadness when subjects read an angry letter and differences in anger when subject read a sad letter.
    For subjects who read an angry letter, they were as likely to report feeling angry when they took Melissa's perspective (\Sexpr{propsad.angry.CvP[3]}\%) as in the control condition (\Sexpr{propsad.angry.CvP[1]}\%) in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_sad3,5)}], and they were equally likely to report feeling sad, 95\% CI [\Sexpr{get.ci(m.sad3,4)}], and down, 95\% CI [\Sexpr{get.ci(m.down3,5)}]. However, they were less likely to report feeling sad when they remained objective (\Sexpr{propsad.angry.OvC[1]}\%) than in the control condition in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_sad2,5)}], and they reported feeling less sad, 95\% CI [\Sexpr{get.ci(m.sad2,4)}], and less down 95\% CI [\Sexpr{get.ci(m.down2,4)}]. Those who remained objective also reported feeling less sad than those who took Melissa's perspective in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_sad1,5)}], and less sad, 95\% CI [\Sexpr{get.ci(m.sad1,4)}], and less down, 95\% CI [\Sexpr{get.ci(m.down1,4)}].
    For subjects who read a sad letter, they were as likely to report feeling angry when they took Melissa's perspective (\Sexpr{propangry.sad.CvP[3]\%}) as in the control condition (\Sexpr{prop.angry.sad.CvP[1]\%}) in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_anger3,5)}], and they were equally likely to report feeling angry, 95\% CI [\Sexpr{get.ci(m.angry3,4)}], and mad, 95\% CI [\Sexpr{get.ci(m.mad3,4)}]. They were also as likely to report feeling angry when they remained objective (\Sexpr{propangry.sad.OvC[1]\%}) as when they took Melissa's perspective, 95\% CI [\Sexpr{get.ci(m.o_anger1,3)}], or were in the control condition, 95\% CI [\Sexpr{get.ci(m.o_anger2,3)}] in the open-ended data. They were also equally likely to report feeling angry, 95\% CI [\Sexpr{get.ci(m.angry2,4)}], and mad, 95\% CI [\Sexpr{get.ci(m.mad2,4)}], as those in the control condition; however, they felt less angry, 95\% CI [\Sexpr{get.ci(m.angry1,4)}], and less mad, 95\% CI [\Sexpr{get.ci(m.mad1,4)}], than those in the perspective taking condition.
...
m.o_anger2 <- glm(o_sympathy~sad.angry+OvC.sad+PvOC.sad+OvC.angry+PvOC.angry, family=binomial(link='logit'), data=ptopen)
...
## perspective taking vs. control
propsymp.angry.CvP <- with(ptopen, get.percent(o_anger, CvP.angry))
...
Figure 3 displays subjects' sympathy in the open-ended and closed-ended data. 
    Subjects were equally likely to report that they felt sympathetic when they read a sad letter from Melissa (\Sexpr{propsymp.angry}\%) as when they read an angry letter from Melissa (\Sexpr{propsymp.sad}\%) in their open-ended responses, 95\% CI [\Sexpr{get.ci(m.o_symp1,2)}]. They also reported feeling equaly sympathetic, 95\% CI [\Sexpr{get.ci(m.symp1,1)}], in the closed-ended data; however, those who read a sad letter felt more compassionate, 95\% CI [\Sexpr{get.ci(m.comp1,1)}].
    
    ## NEED TO FIX EVERYTHING AFTER THIS POINT
    For subjects who read the angry letter, subjects were no more likely to report that they felt angry when they took Melissa's perspective (\Sexpr{propanger.angry.CvP[3]}\%) than in the control condition (\Sexpr{propanger.angry.CvP[1]}\%) in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_anger3,5)}]; they also reported feeling equally angry, 95\% CI [\Sexpr{get.ci(m.angry3,4)}], and mad, 95\% CI [\Sexpr{get.ci(m.mad3,4)}], in the closed-ended data. Those who remained objective were equally likely to report that they felt angry (\Sexpr{propanger.angry.OvC[1]}\%) to those in the control condition in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_anger2,5)}]. However, they reported feeling less angry, 95\% CI [\Sexpr{get.ci(m.angry2,4)}], and mad, 95\% CI [\Sexpr{get.ci(m.mad2,4)}], in the closed-ended data. Those who remained objective also reported feeling less angry than those who took Melissa's perspective in the open-ended data, 95\% CI [\Sexpr{get.ci(m.o_anger1,5)}], and less sad, 95\% CI [\Sexpr{get.ci(m.angry1,4)}], and down, 95\% CI [\Sexpr{get.ci(m.mad1,4)}], than those who took Melissa's perspective in the closed-ended data.
    Once again, there was no evidence that perspective taking caused subjects to feel angry like Melissa, but there was evidence that remaining objective caused them to feel less angry.
