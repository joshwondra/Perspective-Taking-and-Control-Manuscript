...
Figure 2 displays subjects' anger in the open-ended and closed-ended data. 
    ...
    Once again, there was no evidence that perspective taking caused subjects to feel sad like Melissa, but there was evidence that remaining objective caused them to feel less sad.
...
# closed-ended plots
box.symp <- with(pt, nojitterbox(symp, f1=ptfactor, f2=emotfactor, ylab='Sympathy Boxplot'))
box.comp <- with(pt, nojitterbox(compass, f1=ptfactor, f2=emotfactor, ylab='Compassion Boxplot'))
